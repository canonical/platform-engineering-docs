...
#. Any code written complies with the
...
#. The code meets the acceptance criteria of the ticket. This can be established
...
#. If a charm is proposed to be deployed to production based on the release
...
#. Any code merged into the main branch is successfully released to at least the
